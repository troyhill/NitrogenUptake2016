...
``` {r Figure 2 (Data In Brief), fig.width = 6, fig.height = 4}
...
``` {r Figure 2 (JEMBE), fig.width = 6, fig.height = 4}
...
``` {r Figure 3 (JEMBE), fig.width = 6, fig.height = 4}
